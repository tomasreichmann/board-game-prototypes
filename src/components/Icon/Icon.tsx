...
import crowbar from "./media/crowbar.svg";
...
import lanternFlame from "./media/lantern-flame.svg";
import lockedChest from "./media/locked-chest.svg";
import lockPicking from "./media/lock-picking.svg";
import lockpicks from "./media/lockpicks.svg";
...
import paranoia from "./media/paranoia.svg";
...
export default function Icon<AliasMap extends IconMap>({
    ...
    >;
    return <Component className={className} style={{}} {...params} />;
}
