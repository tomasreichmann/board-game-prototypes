...
export default function BattleMap({ className, name, icon, type, slug, effect, cost, children }: BattleMapProps) {
    const iconProps = { className: "h-6 inline-block" };

    return (
        <Paper size="A4" className={clsx("BattleMap bg-white px-2 pt-2 flex flex-col gap-2", className)}>
