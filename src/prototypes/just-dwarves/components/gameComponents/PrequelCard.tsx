            ...
            <div className="absolute top-0 left-0 w-full h-full rounded print:rounded-none overflow-hidden">
                {!isFaceDown && (
                    <div className="absolute left-0 top-0 h-full w-full">
                        <div className="h-1/2 flex flex-col items-center text-jd-shitty-text p-[6mm_6mm]">
                            {isMoistFart ? (
                            ...
                            {!isSpecialLayout && (
                                <div className="text-center font-jd-prequel-body text-[10px] leading-none uppercase ">
                                    {frontTop}
                                </div>
                            )}
                        </div>
                        <div className="h-1/2 flex flex-col items-center rotate-180 text-jd-golden-text p-[6mm_6mm]">
                            {isGetLucky ? (
                        ...
                        {isGetLucky && (
                            <div className="absolute top-0 -right-[55%] rotate-90 h-full w-[150%] flex flex-col justify-center items-center text-center font-jd-prequel-body text-[10px] leading-none uppercase p-[12mm_10mm]">
                                {frontTop}
                            </div>
                        )}
                        {isMoistFart && (
                            <div className="absolute top-0 -right-[55%] rotate-90 h-full w-[150%] flex flex-col justify-center items-center text-center font-jd-prequel-body text-[10px] leading-none uppercase p-[12mm_12mm] text-jd-golden-text">
                                {frontTop}
                            </div>
                        )}
                    </div>
