...
<Hand
    ...
    items={[
        <Outcome key={outcomes[0].slug} {...outcomes[0]} className="not-prose" />,
        <Outcome key={outcomes[1].slug} {...outcomes[1]} className="not-prose" />,
        <Outcome key={outcomes[2].slug} {...outcomes[2]} className="not-prose" />,
        <Outcome key={outcomes[3].slug} {...outcomes[3]} className="not-prose" />,
        <Outcome key={outcomes[4].slug} {...outcomes[4]} className="not-prose" />,
    ]}
/>
...
Kick Ass Cards is best played with **one Game Master and 3-5 players**. Reach out to your friends or look for a group at a gaming convention or your local board game store.
