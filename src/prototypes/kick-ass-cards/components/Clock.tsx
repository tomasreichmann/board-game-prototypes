            ...
            <div className="flex-1 flex flex-col gap-2">
                <div className="relative w-full aspect-square flex flex-col border-2 border-kac-iron rounded-full">
                    {total && (
                        <>
                            <div
                                className={`absolute left-1/2 top-1/2 h-1/2 border-l-2 border-kac-iron [transform-origin:center_top] rotate-[0deg] ml-[-1px]`}
                            ></div>
                            {range(1, total).map((fraction) => {
                                return (
                                    <div
                            ...
                            <div
                                className={`absolute left-1/2 top-1/2 h-1/2 w-1/2 [transform-origin:center_top] rotate-[0deg] rounded-[0_0_100%_0] overflow-hidden hidden`}
                            >
                                <div
                                    className={`absolute left-0 top-0 h-full w-full bg-kac-blood [transform-origin:left_top] rotate-[-15deg]`}
                                ></div>
                            </div>
                        </>
                    )}
