...
export type MetaUserProps = React.PropsWithChildren<{ className?: string } & UserMetaType>;

export default function MetaUser({ className, displayName, imageUrl, children }: MetaUserProps) {
    return (
