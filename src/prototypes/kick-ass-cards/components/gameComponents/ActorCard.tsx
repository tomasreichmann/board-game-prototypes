...
// import "./ActorCardCard.css";

const CharacterOutlineImage = CharacterOutline as unknown as React.ComponentType<SVGProps<SVGElement>>;

export type ActorCardCardProps = React.PropsWithChildren<{ className?: string } & PlayerCharacterType>;

export default function ActorCardCard({
    className,
    name = "",
    occupation = "",
    specials = [],
    ...
    return (
        <div
            className={clsx(
                "ActorCardCard relative bg-white p-5 flex flex-row gap-5 text-kac-steel-dark min-w-[6cm]",
                className
            )}
        >
