...
export default function CreateOrJoinGame({ className }: { className?: string }) {
    ...
    return (
        <div className={twMerge("flex-1 flex flex-col justify-center items-center", className)}>
            ...
            <SignedIn>
                <div className="flex-1 flex flex-col justify-center items-stretch gap-8 self-center max-w-[400px]">
                    <Button variant="solid" color="success" size="xl" onClick={handleCreateGame}>
                        Create a Game
                    </Button>
                    <div className="flex flex-col gap-4 items-center p-4 bg-kac-bone/25 rounded-md">
                        <H2 className="text-kac-gold-darker">Join Game by Code</H2>
                        <div className="flex flex-row items-end gap-2 w-64">
                            <Input
                                type="text"
                                placeholder="####"
                                className="text-lg"
