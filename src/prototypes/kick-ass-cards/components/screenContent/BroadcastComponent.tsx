                ...
                <div className="dropdown dropdown-bottom dropdown-end absolute right-2 top-2 flex flex-col gap-2">
                    {!hideControls && (
                        <>
                            <label
                                tabIndex={0}
                                className="btn btn-sm bg-kac-cloth border-0 hover:bg-kac-cloth-light text-kac-iron print:hidden z-20"
                            >
                                <Icon icon="cast" className="h-4" />
                            </label>
                            <ul
                                tabIndex={0}
                                className="dropdown-content menu menu-compact p-1 shadow bg-kac-steel-light text-kac-monster-dark-content rounded-sm w-24 print:hidden z-20"
                            >
