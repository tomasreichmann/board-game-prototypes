...
-   If a player attempts something dangerous or where the outcome is not clear, the storyteller prompts them to play an Outcome card.
...
-   If a player has 3x Fumble in their hand, they immediately announce it to the storyteller. The storyteller describes the tragedy that has befallen the player.
