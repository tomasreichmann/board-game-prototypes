...
-   Decision: The fire suppression system on the ceiling could slow down the spread of spores in the air, but the temperature in the room will drop dramatically.
    -   Activation of the fire suppression system: Temperature will decrease by -1 for everyone in the club every round. But the locals will not be at risk of spore infection.
