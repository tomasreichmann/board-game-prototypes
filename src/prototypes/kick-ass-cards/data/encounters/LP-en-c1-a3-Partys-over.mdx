...
<List>
    ...
    <Actor
        ...
        {...C.actors.una}
    />
    <Clock {...C.defaultClockProps} {...C.clocks.too_late_for_viktor} />
    <Actor
        {...C.defaultActorProps}
...
-   Decision: The fire suppression system on the ceiling could slow down the spread of spores in the air, but the temperature in the room will drop dramatically.
    -   Activation of the fire suppression system: Everyone in the club receives +1&nbsp;Freezing every round. But the locals will not be at risk of spore infection.
