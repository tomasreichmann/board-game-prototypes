...
<List>
    ...
    <Actor
        {...C.defaultActorProps}
        {...C.characters.infected_recharge_tower}
    />
    <Actor
        {...C.defaultActorProps}
        {...C.characters.firefighting_drones}
    />
    <Asset
        {...C.defaultAssetProps}
        {...C.items.overclocking_battery}
    />
    <Asset
        {...C.defaultAssetProps}
        {...C.items.medi_gel}
...
<List>
    <Actor
        {...C.defaultActorProps}
        {...C.characters.infected_robotic_arm}
    />
    <Actor
        {...C.defaultActorProps}
        {...C.characters.spore_swarm}
    />
</List>
...
<List>
    <Actor
        {...C.defaultActorProps}
        {...C.characters.infected_robotic_arm_2}
    />
    <Asset
        {...C.defaultAssetProps}
        {...C.items.targeting_eye_implant}
    />
</List>
...
<List>
    <Actor
        {...C.defaultActorProps}
        {...C.characters.confused_cargo_beetle}
    />
</List>
...
<List>
    <Actor
        {...C.defaultActorProps}
        {...C.characters.infected_robo_mercenary}
    />
    <Asset
        {...C.defaultAssetProps}
