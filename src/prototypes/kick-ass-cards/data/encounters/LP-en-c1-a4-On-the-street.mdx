...
<List>
    <Actor
        ...
        notes="Action: When injured: Scream - +1&nbsp;Distress in the given and adjacent zones; Impact - movement +1 Injury to everyone in the zone; Wing Gust - move everything in the zone away from the beetle"
    />
</List>
...
<List>
    <Actor
        ...
        notes="Action: Flamethrower - 1x&nbsp;Injury, +1&nbsp;Heat, Zone on fire (+1&nbsp;Heat to everyone in the zone at the beginning of the turn), Blade Fury 2x&nbsp;Injury. Resistant to shooting and melee attacks (-1&nbsp;Effect)."
    />
    <Asset
