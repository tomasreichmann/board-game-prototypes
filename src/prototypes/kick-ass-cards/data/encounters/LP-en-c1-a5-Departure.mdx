...
<List>
    <Actor
        ...
        notes="Action: Scanning - +1 Effect against anything in the zone until the end of the conflict. Flamethrower - 1x&nbsp;Injury, +1&nbsp;Heat, Disintegrator 2x/1x&nbsp;Injury. Resistant to shooting and melee attacks."
    />
    <Actor
        size="Bridge"
