...
-   The first aid kit is on fire
    ...
    -   +1 Burning, if not extinguished before opening.
...
-   There are several doors leading from the corridor:
    ...
    -   Door to the captain's cabin is covered with red spore bushes.
        -   The spore bush emits heat. Each time a character hits it up close, they get +1 Burning.
...
-   The engineering is dominated by the reactor, which is unnaturally humming and vibrating throughout the room.
...
-   The engineering is overgrown with spore thorns, which are slowly expanding and engulfing all the equipment in the room.
...
-   Buxus Monstrum
    -   In the zone: Cloud of Ice Spores: +1 Weight, +1 Freezing
