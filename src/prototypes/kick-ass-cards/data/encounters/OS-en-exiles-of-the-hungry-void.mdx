...
-   If completely destroyed, the system requires a **Spare part** to be repaired.

-   *Reactor* — Reactor MK power source, determines how many ship systems can be active
-   *Engines* — provide thrust to move around and maneuver during fights
-   *Spin drive* — jump to other systems
-   *Weapon systems* — fire weapons
-   *Missile bay* — deploy missiles
-   *Sensors* — find other ships and their systems, plot course to points of interest
-   *Life support* — control temperature and pressure
-   *Cockpit* — navigation, communication
...
-   *A transport in distress* — A transport sent out a distress signal. It is being pursued by pirates.
-   *Abandoned research station* — An abandoned imperial research station. Maybe there's still something of value that hasn't been looted.
-   *A mining colony has a pest problem* — A nearby automated mining colony advertises a job to get rid of giant rodents nesting in its mining shafts.

# A transport in distress

_You jumped to the coordinates of the distress call and see a transport entering a nearby asteroid field followed by a pirate corvette. Both ships seem pretty beat up. The transport's weapons seem to be offline. They seem to try to charge their Spin drive, but cannot while under disruptor fire from the pirates._
...
-   💡 **Sensors:** The pirates are armed with a disruptor and a laser array, their reactor seems to be damaged so they are alternating between them.
...
<List>
    ...
    <Paper size="54x86" orientation="landscape" className="not-prose bg-cover rounded-md" style={{ backgroundImage: 'url(/mighty-decks/encounters/exiles_of_the_hungry_void/locations/elevator.png)' }} />
...
-   Pirates will surrender if their weapons are destroyed.
    -   They offer a box of stims (5x Surge), 1 spin battery (Instantly charges the Spin drive) and a sub-space rescue token (Calls a rescue ship to help you fix your systems and provide fuel for one jump)
