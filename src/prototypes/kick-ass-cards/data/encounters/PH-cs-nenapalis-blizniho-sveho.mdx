...
<List>
    <CounterCard icon="/KAC/counters/euphoria.png" title="Father Zdislav's humiliation" note="Tick up this Counter by the Effect of every player's action to humiliate the priest." reward="The priest will leave the town in shame." total={20} current={0} deck="Hussite chronicles" />
</List>
...
With each stumble and prank, Father Zikmund's curses grow louder and his dignity is slipping further away, but he's still determined to catch you. The chase is far from over, and the next location awaits!
