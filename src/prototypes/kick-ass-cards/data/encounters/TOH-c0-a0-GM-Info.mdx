...
<List>
    <Asset
        ...
        icon="/public/TOH/items/empty-bowl.png"
        title="Wealth level 0"
        effect="Struggling to survive, broke<BR>No income<BR>No savings"
    />
    <Asset
        {...defaultAssetProps}
        size="US game"
        cornerIcon="crownCoin"
        icon="/public/TOH/items/porridge.png"
        title="Wealth level 1"
        effect="Basic necessities (food and shelter)<BR>1 level 1 income<BR>Unskill labour wage (guard or farmer)<BR>Savings for a week"
    />
    <Asset
        {...defaultAssetProps}
        size="US game"
        cornerIcon="crownCoin"
        icon="/public/TOH/items/ribs.png"
        title="Wealth level 2"
        effect="Comfortable living with some luxury and small real estate<BR>1 level 2 income OR 2 level 1 incomes<BR>Skilled farmer wage or small business<BR>Savings for a month"
    />
    <Asset
        {...defaultAssetProps}
        size="US game"
    ...
    <Asset
        ...
        size="US game"
        cornerIcon="crownCoin"
        icon="/public/TOH/items/treasure-chest.png"
        title="Wealth level 4"
        effect="Owning a town or military camp, employing armed forces<BR>1 level 4 income OR 4 level 3 incomes<BR>a town tax income<BR>Savings for a year"
    />
    <Asset
        {...defaultAssetProps}
        size="US game"
        cornerIcon="crownCoin"
        icon="/public/TOH/items/crown.png"
        title="Wealth level 5"
        effect="Wealth of a country<BR>1 level 5 income OR 5 level 4 incomes<BR>Country size tax income<BR>Savings for a year"
    />
