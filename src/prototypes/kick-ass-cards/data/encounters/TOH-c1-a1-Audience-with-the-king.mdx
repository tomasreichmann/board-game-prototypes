...
<List>
    ...
    <Asset
        {...defaultAssetProps}
        size="US game"
        icon="/public/TOH/items/castle-deed.png"
    ...
    <Asset
        {...defaultAssetProps}
        icon="/public/TOH/characters/hunters.png"
...
-   They have an income of level 3 from their current holdings. Troops and craftspeople from the quartermaster are paid for by the king. From the current income, they can employ 3 more skilled craftspeople or 3 loads of resources and they don't need to worry about having enough money to hire unskilled workers, geting decent food or shelter while in a settlement.  
...
<Asset
    ...
    icon="/public/TOH/items/fine-chicken.png"
...
**🎭 Do you want to do anything else before leaving the capitol?**
