...
<List>
    ...
    <Asset
        {...defaultAssetProps}
        icon="/LP/icons/bag.png"
        title="Armored Warhorse"
        effect="A trained warhorse armoured with heavy steel barding."
    />
    <Actor
        size="US game"
    ...
    <Asset
        ...
        effect="Constructing, repairing, or maintaining wooden structures."
    />
    <Asset
        {...defaultAssetProps}
        icon="/LP/icons/bag.png"
        title="Skilled Blacksmith"
        effect="Creating, repairing, or maintaining metal items required in a castle."
    />
    <Asset
        {...defaultAssetProps}
        icon="/LP/icons/bag.png"
        title="Skilled Mason"
        effect="Constructing, repairing, or maintaining stone structures or features."
    />
    <Asset
        {...defaultAssetProps}
        icon="/LP/icons/bag.png"
        title="Skilled Alchemist"
        effect="Creating potions, elixirs, or substances for medicinal or protective purposes."
    />
    <Asset
        {...defaultAssetProps}
        icon="/LP/icons/bag.png"
        title="Skilled Spy"
        effect="Gathering information, infiltrating enemy territories, and conducting covert operations."
    />
    <Asset
        {...defaultAssetProps}
        icon="/LP/icons/bag.png"
    ...
    <Asset
        ...
        effect="Commanding troops, planning defensive or offensive strategies, and advising on military matters."
    />
    <Asset
        {...defaultAssetProps}
        icon="/LP/icons/bag.png"
    ...
    <Asset
        {...defaultAssetProps}
        icon="/LP/icons/bag.png"
        title="Troop of Pike Men"
        effect="Well-trained soldiers specializing in pikes for defensive line or coordinated attacks."
    />
    <Asset
        {...defaultAssetProps}
        icon="/LP/icons/bag.png"
        title="Troop of Archers"
        effect="Skilled bowmen capable of raining arrows down upon enemy troops or fortifications."
    />
    <Asset
        {...defaultAssetProps}
        icon="/LP/icons/bag.png"
