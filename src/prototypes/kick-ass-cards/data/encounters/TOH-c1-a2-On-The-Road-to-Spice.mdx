...
chapter: 1
act: 2
defaultClockProps: { size: "Bridge", className: "not-prose drop-shadow-md print:drop-shadow-none print:filter-none" }
defaultActorProps:
    {
        size: "Bridge",
...
defaultAssetProps:
    { size: "Mini European", className: "not-prose drop-shadow-md print:drop-shadow-none print:filter-none" }
defaultMiniProps:
    {
...
<List>
    <Asset
        size="Mini European"
        icon="/misc/lightning-staff.png"
        className="not-prose drop-shadow-md print:drop-shadow-none print:filter-none"
        title="Staff of Storm&#39;s Fury"
        effect="Attacks for 1 Effect (electric)"
    />
    <Actor
    ...
    />
    <Actor
        name="Sentinel-01 &#39;Echo&#39;"
        notes="Originally a defensive unit, repurposed for offensive purposes. Retains some protective protocols."
        occupation="Reprogrammed Guardian"
        size="Bridge"
        threat="Dual wielding electric katanas for 2 Effect. Can absorb 1 point of damage before taking a hit."
        toughness={2}
        currentToughness={2}
        imageUri="/misc/robot.png"
        className="drop-shadow"
        imagePosition="top"
    />
    <Actor
