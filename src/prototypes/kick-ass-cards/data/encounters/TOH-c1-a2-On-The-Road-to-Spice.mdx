...
<Asset
    ...
    icon="/TOH/items/fine-chicken.png"
    iconClassName="h-auto"
    title="Wealth level 3"
    effect="Wealthy leisure with businesses and staff<BR>1 level 3 income OR 3 level 2 incomes<BR>Booming business or a village tax income<BR>Savings for a season"
/>
