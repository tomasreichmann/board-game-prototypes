const sdApiSchema = {
    ...
    paths: {
        ...
        "/internal/pending-tasks": {
            get: {
                ...
                operationId: "get_pending_tasks_internal_pending_tasks_get",
                responses: {
                    "200": {
                        description: "Successful Response",
                        content: {
        ...
        "/sdapi/v1/refresh-embeddings": {
            post: {
                ...
                operationId: "refresh_embeddings_sdapi_v1_refresh_embeddings_post",
                responses: {
                    "200": {
                        description: "Successful Response",
                        content: {
        ...
        "/sdapi/v1/extensions": {
            get: {
                ...
                operationId: "get_extensions_list_sdapi_v1_extensions_get",
                responses: {
                    "200": {
                        description: "Successful Response",
                        content: {
                            "application/json": {
                                schema: {
                                    title: "Response Get Extensions List Sdapi V1 Extensions Get",
                                    type: "array",
                                    items: {
        ...
        "/adetailer/v1/version": {
            get: {
                summary: "Version",
                operationId: "version_adetailer_v1_version_get",
                responses: {
                    "200": {
                        description: "Successful Response",
                        content: {
        ...
        "/adetailer/v1/schema": {
            get: {
                summary: "Schema",
                operationId: "schema_adetailer_v1_schema_get",
                responses: {
                    "200": {
                        description: "Successful Response",
                        content: {
        ...
        "/adetailer/v1/ad_model": {
            get: {
                summary: "Ad Model",
                operationId: "ad_model_adetailer_v1_ad_model_get",
                responses: {
                    "200": {
                        description: "Successful Response",
                        content: {
        ...
        "/controlnet/render_openpose_json": {
            post: {
                summary: "Render Openpose Json",
                operationId: "render_openpose_json_controlnet_render_openpose_json_post",
                requestBody: {
                    content: {
                        "application/json": {
                            schema: {
                                title: "Pose json files to render.",
                                type: "array",
                                items: {
                                    $ref: "#/components/schemas/PoseData",
                                },
                                default: [],
                            },
                        },
            ...
            post: {
                ...
                requestBody: {
                    content: {
                        "application/json": {
                            schema: {
                                $ref: "#/components/schemas/DeleteFilesReq",
                            },
                        },
                    },
                    required: true,
            ...
            post: {
                ...
                requestBody: {
                    content: {
                        "application/json": {
                            schema: {
                                $ref: "#/components/schemas/CreateFoldersReq",
                            },
                        },
                    },
                    required: true,
            ...
            post: {
                ...
                requestBody: {
                    content: {
                        "application/json": {
                            schema: {
                                $ref: "#/components/schemas/MoveFilesReq",
                            },
                        },
                    },
                    required: true,
        ...
        "/infinite_image_browsing/files": {
            get: {
                summary: "Get Target Folder Files",
                operationId: "get_target_folder_files_infinite_image_browsing_files_get",
                parameters: [
                    {
                        required: true,
                        schema: {
        ...
        "/infinite_image_browsing/image_geninfo_batch": {
            post: {
                summary: "Image Geninfo Batch",
                operationId: "image_geninfo_batch_infinite_image_browsing_image_geninfo_batch_post",
                requestBody: {
                    content: {
                        "application/json": {
                            schema: {
                                $ref: "#/components/schemas/GeninfoBatchReq",
                            },
                        },
                    },
                    required: true,
            ...
            post: {
                ...
                requestBody: {
                    content: {
                        "application/json": {
                            schema: {
                                $ref: "#/components/schemas/CheckPathExistsReq",
                            },
                        },
                    },
                    required: true,
        ...
        "/infinite_image_browsing/fe-static/{file_path}": {
            get: {
                ...
                operationId: "serve_static_file_infinite_image_browsing_fe_static__file_path__get",
                parameters: [
                    {
                        required: true,
                        schema: {
            ...
            post: {
                ...
                requestBody: {
                    content: {
                        "application/json": {
                            schema: {
                                $ref: "#/components/schemas/OpenFolderReq",
                            },
                        },
                    },
                    required: true,
            ...
            post: {
                ...
                requestBody: {
                    content: {
                        "application/json": {
                            schema: {
                                $ref: "#/components/schemas/PathsReq",
                            },
                        },
                    },
                    required: true,
        ...
        "/infinite_image_browsing/db/search_by_substr": {
            post: {
                ...
                operationId: "search_by_substr_infinite_image_browsing_db_search_by_substr_post",
                requestBody: {
                    content: {
                        "application/json": {
                            schema: {
                                $ref: "#/components/schemas/SearchBySubstrReq",
                            },
                        },
                    },
                    required: true,
            ...
            post: {
                ...
                requestBody: {
                    content: {
                        "application/json": {
                            schema: {
                                $ref: "#/components/schemas/MatchImagesByTagsReq",
                            },
                        },
                    },
                    required: true,
        ...
        "/infinite_image_browsing/db/batch_update_image_tag": {
            post: {
                summary: "Batch Update Image Tag",
                operationId: "batch_update_image_tag_infinite_image_browsing_db_batch_update_image_tag_post",
                requestBody: {
                    content: {
                        "application/json": {
                            schema: {
                                $ref: "#/components/schemas/BatchUpdateImageReq",
                            },
                        },
                    },
                    required: true,
            ...
            post: {
                ...
                requestBody: {
                    content: {
                        "application/json": {
                            schema: {
                                $ref: "#/components/schemas/AddCustomTagReq",
                            },
                        },
                    },
                    required: true,
            ...
            post: {
                ...
                requestBody: {
                    content: {
                        "application/json": {
                            schema: {
                                $ref: "#/components/schemas/RemoveCustomTagReq",
                            },
                        },
                    },
                    required: true,
            ...
            post: {
                ...
                requestBody: {
                    content: {
                        "application/json": {
                            schema: {
                                $ref: "#/components/schemas/ExtraPathModel",
                            },
                        },
                    },
                    required: true,
        ...
        "/lobe/package": {
            get: {
                summary: "Lobe Package Get",
                operationId: "lobe_package_get_lobe_package_get",
                responses: {
                    "200": {
                        description: "Successful Response",
                        content: {
        ...
        "/lobe/prompt": {
            get: {
                summary: "Lobe Prompt Get",
                operationId: "lobe_prompt_get_lobe_prompt_get",
                responses: {
                    "200": {
                        description: "Successful Response",
                        content: {
        ...
        "/lobe/locales/{lng}": {
            get: {
                summary: "Lobe Locale Get",
                operationId: "lobe_locale_get_lobe_locales__lng__get",
                parameters: [
                    {
                        required: true,
                        schema: {
        ...
        "/lobe/config": {
            get: {
                summary: "Lobe Config Get",
                operationId: "lobe_config_get_lobe_config_get",
                responses: {
                    "200": {
                        description: "Successful Response",
                        content: {
            ...
            post: {
                summary: "Lobe Config Save",
                operationId: "lobe_config_save_lobe_config_post",
                responses: {
                    "200": {
                        description: "Successful Response",
                        content: {
            ...
            delete: {
                summary: "Lobe Config Delete",
                operationId: "lobe_config_delete_lobe_config_delete",
                responses: {
                    "200": {
                        description: "Successful Response",
                        content: {
        ...
        "/rembg": {
            post: {
                ...
                operationId: "rembg_remove_rembg_post",
                requestBody: {
                    content: {
                        "application/json": {
                            schema: {
                                $ref: "#/components/schemas/Body_rembg_remove_rembg_post",
                            },
                        },
                    },
                },
    ...
    components: {
        schemas: {
            ...
            BatchUpdateImageReq: {
                title: "BatchUpdateImageReq",
                required: ["img_paths", "action", "tag_id"],
                type: "object",
                properties: {
                    img_paths: {
                        title: "Img Paths",
            ...
            Body_rembg_remove_rembg_post: {
                title: "Body_rembg_remove_rembg_post",
                type: "object",
                properties: {
                    input_image: {
                        title: "rembg input image",
                        type: "string",
                        default: "",
                    },
                    model: {
            ...
            ExtensionItem: {
                title: "ExtensionItem",
                required: ["name", "remote", "branch", "commit_hash", "version", "commit_date", "enabled"],
                type: "object",
                properties: {
                    name: {
                        title: "Name",
            ...
            ExtraPathModel: {
                ...
                properties: {
                    ...
                    type: {
                        $ref: "#/components/schemas/ExtraPathType",
                    },
                },
            },
            ExtraPathType: {
            ...
            Flags: {
                ...
                properties: {
                    ...
                    data_dir: {
                        ...
                        default: "C:\\AI\\A1111 Web UI Autoinstaller\\stable-diffusion-webui",
                    },
                    config: {
                        title: "Config",
                        type: "string",
                        ...
                        default:
                            "C:\\AI\\A1111 Web UI Autoinstaller\\stable-diffusion-webui\\configs\u000b1-inference.yaml",
                    },
                    ckpt: {
                        title: "Ckpt",
                        type: "string",
                        ...
                        default: "C:\\AI\\A1111 Web UI Autoinstaller\\stable-diffusion-webui\\model.ckpt",
                    },
                    ckpt_dir: {
                        title: "Ckpt Dir",
                        type: "string",
                    ...
                    embeddings_dir: {
                        ...
                        default: "C:\\AI\\A1111 Web UI Autoinstaller\\stable-diffusion-webui\\embeddings",
                    },
                    textual_inversion_templates_dir: {
                        ...
                        default:
                            "C:\\AI\\A1111 Web UI Autoinstaller\\stable-diffusion-webui\textual_inversion_templates",
                    },
                    hypernetwork_dir: {
                        title: "Hypernetwork Dir",
                        type: "string",
                        description: "hypernetwork directory",
                        default: "C:\\AI\\A1111 Web UI Autoinstaller\\stable-diffusion-webui\\models\\hypernetworks",
                    },
                    localizations_dir: {
                        title: "Localizations Dir",
                        type: "string",
                        description: "localizations directory",
                        default: "C:\\AI\\A1111 Web UI Autoinstaller\\stable-diffusion-webui\\localizations",
                    },
                    allow_code: {
                        title: "Allow Code",
                        type: "boolean",
                    ...
                    codeformer_models_path: {
                        ...
                        default: "C:\\AI\\A1111 Web UI Autoinstaller\\stable-diffusion-webui\\models\\Codeformer",
                    },
                    gfpgan_models_path: {
                        title: "Gfpgan Models Path",
                        type: "string",
                        description: "Path to directory with GFPGAN model file(s).",
                        default: "C:\\AI\\A1111 Web UI Autoinstaller\\stable-diffusion-webui\\models\\GFPGAN",
                    },
                    esrgan_models_path: {
                        title: "Esrgan Models Path",
                        type: "string",
                        description: "Path to directory with ESRGAN model file(s).",
                        default: "C:\\AI\\A1111 Web UI Autoinstaller\\stable-diffusion-webui\\models\\ESRGAN",
                    },
                    bsrgan_models_path: {
                        title: "Bsrgan Models Path",
                        type: "string",
                        description: "Path to directory with BSRGAN model file(s).",
                        default: "C:\\AI\\A1111 Web UI Autoinstaller\\stable-diffusion-webui\\models\\BSRGAN",
                    },
                    realesrgan_models_path: {
                        title: "Realesrgan Models Path",
                        type: "string",
                        description: "Path to directory with RealESRGAN model file(s).",
                        default: "C:\\AI\\A1111 Web UI Autoinstaller\\stable-diffusion-webui\\models\\RealESRGAN",
                    },
                    dat_models_path: {
                        title: "Dat Models Path",
                        type: "string",
                        description: "Path to directory with DAT model file(s).",
                        default: "C:\\AI\\A1111 Web UI Autoinstaller\\stable-diffusion-webui\\models\\DAT",
                    },
                    clip_models_path: {
                    ...
                    ui_config_file: {
                        ...
                        default: "C:\\AI\\A1111 Web UI Autoinstaller\\stable-diffusion-webui\\ui-config.json",
                    },
                    hide_ui_dir_config: {
                    ...
                    freeze_settings_in_sections: {
                        title: "Freeze Settings In Sections",
                        type: "string",
                        description:
                    ...
                    freeze_specific_settings: {
                        title: "Freeze Specific Settings",
                        type: "string",
                        description:
                    ...
                    ui_settings_file: {
                        ...
                        default: "C:\\AI\\A1111 Web UI Autoinstaller\\stable-diffusion-webui\\config.json",
                    },
                    gradio_debug: {
                        title: "Gradio Debug",
                        type: "boolean",
                    ...
                    skip_load_model_at_start: {
                        title: "Skip Load Model At Start",
                        type: "boolean",
                    ...
                    controlnet_tracemalloc: {
                        title: "Controlnet Tracemalloc",
                        type: "string",
                    ...
                    ldsr_models_path: {
                        ...
                        default: "C:\\AI\\A1111 Web UI Autoinstaller\\stable-diffusion-webui\\models\\LDSR",
                    },
                    lora_dir: {
                        title: "Lora Dir",
                        type: "string",
                        description: "Path to directory with Lora networks.",
                        default: "C:\\AI\\A1111 Web UI Autoinstaller\\stable-diffusion-webui\\models\\Lora",
                    },
                    lyco_dir_backcompat: {
                        ...
                        default: "C:\\AI\\A1111 Web UI Autoinstaller\\stable-diffusion-webui\\models\\LyCORIS",
                    },
                    scunet_models_path: {
                        title: "Scunet Models Path",
                        type: "string",
                        description: "Path to directory with ScuNET model file(s).",
                        default: "C:\\AI\\A1111 Web UI Autoinstaller\\stable-diffusion-webui\\models\\ScuNET",
                    },
                    swinir_models_path: {
                        title: "Swinir Models Path",
                        type: "string",
                        description: "Path to directory with SwinIR model file(s).",
                        default: "C:\\AI\\A1111 Web UI Autoinstaller\\stable-diffusion-webui\\models\\SwinIR",
                    },
                },
            },
            GeninfoBatchReq: {
                title: "GeninfoBatchReq",
                required: ["paths"],
                type: "object",
                properties: {
                    paths: {
            ...
            Options: {
                ...
                properties: {
                    ...
                    save_images_replace_action: {
                        title: "Save Images Replace Action",
                        type: "string",
                    ...
                    enable_upscale_progressbar: {
                        title: "Enable Upscale Progressbar",
                        type: "boolean",
                    ...
                    auto_vae_precision_bfloat16: {
                        title: "Auto Vae Precision Bfloat16",
                    ...
                    img2img_batch_show_results_limit: {
                        title: "Img2Img Batch Show Results Limit",
                        type: "number",
                        description: "Show the first N batch img2img results in UI",
                        default: 32,
                    },
                    overlay_inpaint: {
                        title: "Overlay Inpaint",
                        type: "boolean",
                    ...
                    cache_fp16_weight: {
                        title: "Cache Fp16 Weight",
                        description: "Cache FP16 weight for LoRA",
                        default: false,
                    },
                    auto_backcompat: {
                        title: "Auto Backcompat",
                        type: "boolean",
                    ...
                    use_downcasted_alpha_bar: {
                        title: "Use Downcasted Alpha Bar",
                        description:
                    ...
                    extra_networks_dir_button_function: {
                        title: "Extra Networks Dir Button Function",
                    ...
                    keyedit_delimiters_whitespace: {
                        title: "Keyedit Delimiters Whitespace",
                        type: "array",
                        items: {},
                        description: "Ctrl+up/down whitespace delimiters",
                        default: ["Tab", "Carriage Return", "Line Feed"],
                    },
                    keyedit_move: {
                        title: "Keyedit Move",
                        type: "boolean",
                    ...
                    include_styles_into_token_counters: {
                        title: "Include Styles Into Token Counters",
                        type: "boolean",
                    ...
                    open_dir_button_choice: {
                        title: "Open Dir Button Choice",
                        type: "string",
                        description: "What directory the [📂] button opens",
                        default: "Subdirectory",
                    },
                    compact_prompt_box: {
                        title: "Compact Prompt Box",
                    ...
                    sd_checkpoint_dropdown_use_short: {
                        title: "Sd Checkpoint Dropdown Use Short",
                    ...
                    js_live_preview_in_modal_lightbox: {
                        title: "Js Live Preview In Modal Lightbox",
                    ...
                    postprocessing_existing_caption_action: {
                        title: "Postprocessing Existing Caption Action",
                        type: "string",
                    ...
                    lora_hide_unknown_for_versions: {
                        title: "Lora Hide Unknown For Versions",
                        description: "Hide networks of unknown versions for model versions",
                        default: [],
                    },
                    lora_in_memory_limit: {
                        title: "Lora In Memory Limit",
                        description: "Number of Lora networks to keep cached in memory",
                        default: 0,
                    },
                    lora_not_found_warning_console: {
                        title: "Lora Not Found Warning Console",
                        description: "Lora not found warning in console",
                        default: false,
                    },
                    lora_not_found_gradio_warning: {
                        title: "Lora Not Found Gradio Warning",
                        description: "Lora not found warning popup in webui",
                        default: false,
                    },
                    lora_functional: {
                        title: "Lora Functional",
                        description:
                    ...
                    canvas_hotkey_shrink_brush: {
                        title: "Canvas Hotkey Shrink Brush",
                        type: "string",
                        description: "Shrink the brush size",
                        default: "Q",
                    },
                    canvas_hotkey_grow_brush: {
                        title: "Canvas Hotkey Grow Brush",
                        type: "string",
                        description: "Enlarge the brush size",
                        default: "W",
                    },
                    canvas_hotkey_move: {
                    ...
                    canvas_disabled_functions: {
                        title: "Canvas Disabled Functions",
                        type: "array",
                        items: {},
            ...
            PNGInfoResponse: {
                ...
                required: ["info", "items", "parameters"],
                type: "object",
                properties: {
                    info: {
                        title: "Image info",
            ...
            PoseData: {
                title: "PoseData",
                required: ["people", "canvas_width", "canvas_height"],
                type: "object",
                properties: {
                    people: {
                        title: "People",
            ...
            SearchBySubstrReq: {
                title: "SearchBySubstrReq",
                required: ["surstr", "cursor", "regexp"],
                type: "object",
                properties: {
                    surstr: {
                        title: "Surstr",
...
/* console.log(
    JSON.stringify(
        Object.fromEntries(
            Object.entries(sdApiSchema.components.schemas.TextToImageResponse.properties).map(([key, value]) => [
                key,
                ((value || {}) as any).type ||
                    (((value || {}) as any).default !== undefined && typeof ((value || {}) as any).default) ||
                    "string",
            ])
        ),
        null,
